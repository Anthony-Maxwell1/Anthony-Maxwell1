...
export const themes = {
  ...
  "retro-mac": {
    ...
    extraHtml: `
        <div class="bg-repeat absolute inset-0 pointer-events-none opacity-40" style="background-image: url('/images/themes/retro-mac/brushedmetal.png');"></div>
        `,
    TopBar: `
        <div class="absolute top-0 left-0 right-0 h-7 flex items-center px-3 gap-2 z-20">
        ...
        <div class="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 flex-1 text-center text-xs font-semibold text-gray-700 select-none pointer-events-none font-mac">
            {__TILE_TITLE__}
        </div>
    `,
    Data: {},
...
const THEME = "retro-mac";

export const classes = themes[THEME].classes;
export const topBar = themes[THEME].TopBar || "";
export const extraHtml = themes[THEME].extraHtml || "";
...
export const currentPage = {
  id: "428303c3-d6e4-438d-9c80-41483c601a44",
  tiles: [
    {
